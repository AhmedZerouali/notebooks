...
def draw_text(fig, ax, x, y, text, color=[0, 0, 0, 1], fontsize=18):
    ax.text(
        x, y, text,
...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    # legend
    #draw_text(fig, ax, 0.02, 0.72, names[0], 'black', fontsize=fontsize)
    #draw_text(fig, ax, 0.72, 0.94, names[1], 'black', fontsize=fontsize)
    #draw_text(fig, ax, 0.97, 0.74, names[2], 'black', fontsize=fontsize)
    #draw_text(fig, ax, 0.88, 0.05, names[3], 'black', fontsize=fontsize)
    #draw_text(fig, ax, 0.12, 0.05, names[4], 'black', fontsize=fontsize)
    leg = ax.legend(names, loc='upper left', fontsize=13, bbox_to_anchor=(-0.1, 1.01), fancybox=True, shadow=True)
